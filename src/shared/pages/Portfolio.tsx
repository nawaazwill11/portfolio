...
const Introduction = ({ data }: { data: TSectionIntroduction }) => {
  ...
  return (
    <section
      id="introduction"
      style={{ backgroundImage: `url('/static/img/${background()}')` }}
    >
...
const Profile = ({ data }: { data: TSectionProfile }) => {
  const getAge = () => {
    ...
    if (
      today.getMonth() + 1 > 11 ||
      (today.getMonth() + 1 === 11 && today.getDate() >= 24)
    ) {
          ...
          <div className="row profile-row">
            ...
            <div className="col-lg-4">
              ...
              {details.map((info) => (
                <p key={Math.random()}>
                  <span>
                    <strong className="info-head">{info[0]}</strong>
                  </span>
                  <br />
                  <span>{info[1]}</span>
                </p>
    ...
    xps.map((xp) => {
      return (
        <div key={Math.random()} className="row">
          <div className="col-lg-4">
            <h4>
              <a href={xp.premise.href}>{xp.premise.name}</a>
            </h4>
  ...
  return (
    <section id="experiences" className="body-colored">
      <div className="container">
        ...
        <div className="content">
          <h3>Educations</h3>
          <div className="experiences">{xpFactory(data.educations)}</div>
          <hr />
          <h3>Careers</h3>
          <div className="experiences">{xpFactory(data.careers)}</div>
        </div>
      </div>
    </section>
  );
        ...
        <div className="content">
          ...
          <div className="ability">
            ...
            <div className="row">
              {skillFactory(
                data.languages,
                Math.ceil(data.languages.length / 2)
              )}
            </div>
          </div>
        </div>
          ...
          <div className="project-overview">
            ...
            <p className="info">
              ...
              <span className="border-0">
                {project.duration} {project.ongoing ? "| On-going" : ""}
              </span>
            </p>
            <a
            ...
            <a className="hidden-link" href={project.href}>
              View
            </a>
          </div>
        </div>
  ...
  return (
    <section id="projects" className="body-colored">
      <div className="container">
        ...
        <hr />
        <div className="content">
          <div className="row">{projectFactory(data.projects)}</div>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <footer id="contact">
      <div className="container">
        ...
        <div className="content">
          ...
          <div className="hire-me">
            ...
            <h4>
              Contact me on: <a href="tel:+919737177329">+91 97371 77329</a>
            </h4>
          </div>
        </div>
      </div>
      ...
      <div className="portfolio-redirect">
        <a href="https://nawaaz.dev/portfolio">
          Check out my Interactive Portofolio for more
        </a>
      </div>
    </footer>
  );
